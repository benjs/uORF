...
class uorfTestGanModel(uorfGanModel):
    ...
    def test_step(self, batch, batch_idx):
        ...
        print('loss_lpips', loss_lpips.cpu().item(), '-', self.loss_lpips_avg.avg)
        print('loss_psnr', loss_psnr.cpu().item(), '-', self.loss_psnr_avg.avg)
        print('loss_ssim', loss_ssim.cpu().item(), '-', self.loss_ssim_avg.avg)
